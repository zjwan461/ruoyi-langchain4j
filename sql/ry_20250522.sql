...
(
    ...
    remark      varchar(255) default null comment '备注',
    primary key (`id`)
) engine=innodb  auto_increment=1 comment='知识库';
...
(
    ...
    primary key (id)
) engine=innodb auto_increment=1 comment='ai智能体';
...
VALUES ('AI工具箱', 0, 0, 'ai', NULL, NULL, '', 1, 0, 'M', '0', '0', NULL, 'component', 'admin', '2025-09-07 00:37:57',
        '', NULL, '');

SELECT @aiRootId := LAST_INSERT_ID();
-- 菜单 SQL
...
values ('模型管理', @aiRootId, '1', 'model', 'ai/model/index', 1, 0, 'C', '0', '0', 'ai:model:list', 'build', 'admin',
        sysdate(), '', null, '模型管理菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('模型管理查询', @parentId, '1', '#', '', 1, 0, 'F', '0', '0', 'ai:model:query', '#', 'admin', sysdate(), '',
        null, '');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('模型管理修改', @parentId, '3', '#', '', 1, 0, 'F', '0', '0', 'ai:model:edit', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('模型管理删除', @parentId, '4', '#', '', 1, 0, 'F', '0', '0', 'ai:model:remove', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('模型管理导出', @parentId, '5', '#', '', 1, 0, 'F', '0', '0', 'ai:model:export', '#', 'admin', sysdate(), '',
        null, '');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库管理', @aiRootId, '1', 'knowledgeBase', 'ai/knowledgeBase/index', 1, 0, 'C', '0', '0',
        'ai:knowledgeBase:list', 'dict', 'admin', sysdate(), '', null, '知识库菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库查询', @parentId, '1', '#', '', 1, 0, 'F', '0', '0', 'ai:knowledgeBase:query', '#', 'admin', sysdate(),
        '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库新增', @parentId, '2', '#', '', 1, 0, 'F', '0', '0', 'ai:knowledgeBase:add', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库修改', @parentId, '3', '#', '', 1, 0, 'F', '0', '0', 'ai:knowledgeBase:edit', '#', 'admin', sysdate(),
        '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库删除', @parentId, '4', '#', '', 1, 0, 'F', '0', '0', 'ai:knowledgeBase:remove', '#', 'admin', sysdate(),
        '', null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('知识库导出', @parentId, '5', '#', '', 1, 0, 'F', '0', '0', 'ai:knowledgeBase:export', '#', 'admin', sysdate(),
        '', null, '');

-- 菜单 SQL
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('智能体管理', @aiRootId, '1', 'agent', 'ai/agent/index', 1, 0, 'C', '0', '0', 'ai:agent:list', 'message',
        'admin', sysdate(), '', null, 'AI智能体菜单');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('AI智能体查询', @parentId, '1', '#', '', 1, 0, 'F', '0', '0', 'ai:agent:query', '#', 'admin', sysdate(), '',
        null, '');
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('AI智能体修改', @parentId, '3', '#', '', 1, 0, 'F', '0', '0', 'ai:agent:edit', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('AI智能体删除', @parentId, '4', '#', '', 1, 0, 'F', '0', '0', 'ai:agent:remove', '#', 'admin', sysdate(), '',
        null, '');

insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('AI智能体导出', @parentId, '5', '#', '', 1, 0, 'F', '0', '0', 'ai:agent:export', '#', 'admin', sysdate(), '',
        null, '');
...
INSERT INTO sys_dict_type (dict_name, dict_type, status, create_by, create_time, update_by, update_time,
                           remark)
VALUES ('AI模型类型', 'ai_model_type', '0', 'admin', '2025-09-07 00:49:08', '', NULL, NULL),
       ('AI模型提供商', 'ai_model_provider', '0', 'admin', '2025-09-07 00:50:59', '', NULL, NULL),
       ('AI智能体状态', 'ai_agent_status', '0', 'admin', '2025-09-07 00:53:36', '', NULL, NULL);

INSERT INTO sys_dict_data (dict_sort, dict_label, dict_value, dict_type, css_class, list_class, is_default,
                           status, create_by, create_time, update_by, update_time, remark)
VALUES (0, 'LLM', '0', 'ai_model_type', NULL, 'primary', 'N', '0', 'admin', '2025-09-07 00:49:48', '', NULL, NULL),
       (0, 'EMBEDDING', '1', 'ai_model_type', NULL, 'info', 'N', '0', 'admin', '2025-09-07 00:49:58', '', NULL, NULL),
       (0, 'OLLAMA', 'Ollama', 'ai_model_provider', NULL, 'primary', 'N', '0', 'admin', '2025-09-07 00:51:25', '', NULL,
        NULL),
       (0, 'OPEN_AI', 'Open AI', 'ai_model_provider', NULL, 'success', 'N', '0', 'admin', '2025-09-07 00:51:44', '',
        NULL, NULL),
       (0, '未启用', '0', 'ai_agent_status', NULL, 'primary', 'N', '0', 'admin', '2025-09-07 00:54:18', 'admin',
